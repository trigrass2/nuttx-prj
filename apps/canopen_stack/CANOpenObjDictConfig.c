...
/* Includes ------------------------------------------------------------------*/
#include "canopen_stack/CANOpenObjDictConfig.h"
...
void Master_initialisation(CO_Data* d)
{
	...
	UNS32 TPDO1_COBID = 0x027F; 
	UNS32 RPDO1_COBID = 0x1FF;
	UNS32 TPDO2_COBID = 0x37F; 
	UNS32 RPDO2_COBID = 0x3FF;
...
void CanopenInit(void)
{
    ...
    /* Initialize the canopen  protocol stack  Master*/
	CANOpenMasterObject->canHandle = NULL;
